...
const TopBar = props => {
  ...
  useEffect(() => {
    ...
    const obsorder = ordersdoc.onSnapshot(docSnapshot => {
      let data = [];
      docSnapshot.docChanges().forEach(function (change) {
        if (change.type === "added") {
          ...
          if(data.id!==undefined){
            firebase.firestore().collection("notifications").where("id","==",data.id).get().then(function(querySnapshot) {
    ...
    //      // console.log(data);
    //       if(data.id!==undefined){
    //         let find = firebase.firestore().collection("notifications").where("id","==",data.id).get().then(function(querySnapshot) {
    //           querySnapshot.forEach(function(doc) {
    //             if(!doc.data()){
    //               firebase.firestore().collection('notifications').add(data);
    //             }
    ...
    //     //   data = {
    //     //     id: change.doc.data().uid,
    //     //     title: 'User ' + change.doc.data().email + ' is modified',
    //     //     type: 'user',
    //     //     case: 'modified',
    //     //     date: firebase.firestore.FieldValue.serverTimestamp()
    //     //   };
    ...
    //     //   data = [{
    //     //     id: change.doc.data().uid,
    //     //     title: 'New user removed' + change.doc.data().email + ' is removed',
    //     //     type: 'user',
    //     //     case: 'deleted',
    //     //     date: firebase.firestore.FieldValue.serverTimestamp()
    //     //   }];
    ...
    //   });
    //   let datos = [];
    //   firebase.firestore().collection("notifications").orderBy("date")
    // .get().then(function(querySnapshot) {
    //     querySnapshot.forEach(function(doc) {
    //       datos.push(doc.data());
