...
const RequestEdit = props => {
  const { open, onClose, request, className, ...rest } = props;
            ...
            >
              ...
              >
                ...
                <Typography variant="body2">
                  Disabling this will automatically send the request a verification
                  email
                </Typography>
                <Switch
              ...
              >
                ...
                <Typography variant="body2">
                  This will give the request discountedprices for all products
                </Typography>
                <Switch
