...
const OtherActions = props => {
  const { className, customer,actualizar, ...rest } = props;
  const customerId = customer.uid;
  const classes = useStyles();
  
  const disableAccount = ()=>{
  let params = { "uid":customerId, "isActive":false }
  ...
  const enableAccount = ()=>{
    let params = { "uid":customerId, "isActive":true }
