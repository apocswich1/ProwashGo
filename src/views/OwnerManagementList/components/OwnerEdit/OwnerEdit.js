...
const OwnerEdit = props => {
  const { open, onClose, owner, className, ...rest } = props;
            ...
            >
              ...
              >
                ...
                <Typography variant="body2">
                  Disabling this will automatically send the owner a verification
                  email
                </Typography>
                <Switch
              ...
              >
                ...
                <Typography variant="body2">
                  This will give the owner discountedprices for all products
                </Typography>
                <Switch
...
OwnerEdit.displayName = 'OwnerEdit';
