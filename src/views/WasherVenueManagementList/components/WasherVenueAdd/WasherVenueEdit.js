...
const WasherVenueEdit = props => {
  const { open, onClose, washer, className, ...rest } = props;
            ...
            >
              ...
              >
                ...
                <Typography variant="body2">
                  Disabling this will automatically send the washer a verification
                  email
                </Typography>
                <Switch
...
export default WasherVenueEdit;
