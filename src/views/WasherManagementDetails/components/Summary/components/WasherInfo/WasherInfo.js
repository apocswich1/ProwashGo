...
const WasherInfo = props => {
  const { washer, className, cboFranchises, actualizar, ...rest } = props;
        ...
        <Table>
          ...
          <TableRow>
              ...
              <div style={{width:"150px", height:"150px",borderRadius:"50%"}}>
                <img src={washer.avatar ? washer.avatar : '/images/perfil.png'} style={{borderRadius:"50%"}} width="180px" height="180px"/>
                </div>
              </TableCell>
              <TableCell>
              <TableRow>
          ...
          <TableRow>
            ...
            <TableRow>
              ...
              <TableCell>{washer.promedio}</TableCell>
            </TableRow>
          {/* <TableRow>
