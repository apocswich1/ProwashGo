...
const RateEdit = props => {
  const { open, onClose, rate, className, ...rest } = props;
            ...
            >
              ...
              >
                ...
                <Typography variant="body2">
                  Disabling this will automatically send the rate a verification
                  email
                </Typography>
                <Switch
              ...
              >
                ...
                <Typography variant="body2">
                  This will give the rate discountedprices for all products
                </Typography>
                <Switch
