...
const OwnerManagementDetails = props => {
  ...
  if (!tab) {
    return <Redirect to={`/management/owners/${id}/summary`} />;
  }
...
OwnerManagementDetails.propTypes = {
  history: PropTypes.object.isRequired,
  match: PropTypes.object.isRequired
};

export default OwnerManagementDetails;
