...
const VehicleEdit = props => {
  const { open, onClose, vehicle, className, ...rest } = props;
            ...
            >
              ...
              >
                ...
                <Typography variant="body2">
                  Disabling this will automatically send the vehicle a verification
                  email
                </Typography>
                <Switch
              ...
              >
                ...
                <Typography variant="body2">
                  This will give the vehicle discountedprices for all products
                </Typography>
                <Switch
