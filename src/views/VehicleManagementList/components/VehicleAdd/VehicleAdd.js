...
const DriverAdd = props => {
  const { open, onClose, driver, className, ...rest } = props;
            ...
            >
              ...
              >
                ...
                <Typography variant="body2">
                  Disabling this will automatically send the driver a verification
                  email
                </Typography>
                <Switch
              ...
              >
                ...
                <Typography variant="body2">
                  This will give the driver discountedprices for all products
                </Typography>
                <Switch
