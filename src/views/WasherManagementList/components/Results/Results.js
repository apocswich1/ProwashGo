...
const Results = props => {
  ...
  return (
    ...
    >
              ...
              <Table>
                <TableHead>
                  <TableRow>
                    ...
                    <TableCell onClick={()=>sortData(washers,'promedio',sort)}>{t("Promedio")}</TableCell>
                ...
                <TableBody>
                  {//washers.slice(0, rowsPerPage).map(washer => (
                    ...
                    >
                        ...
                        <div className={classes.nameCell}>
                          ...
                          <div>
                            <Link
                              ...
                              to={`/management/washers/${washer.id}`}
                      ...
                      <TableCell>{new String(washer.promedio)}</TableCell>
      ...
      <TableEditBarWasher selected={selectedWashers} actualizar={actualizar} setselected={() => setselected()}/>
    </div>
  );
};
