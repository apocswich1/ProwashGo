...
useEffect(() => {
    const fetchWashers2 = () => {
      ...
      fetchWashers2();
        ...
        return (
            <ExcelFile element={<button style={{backgroundColor:colors.blue['600'],color:"#ffffff", marginRight:"10px"}} className="MuiButtonBase-root MuiButton-root makeStyles-deleteButton-456 MuiButton-text">Export Washer</button>}>
