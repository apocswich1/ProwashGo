...
useEffect(() => {
    const fetchCustomers2 = () => {
      ...
      fetchCustomers2();
        ...
        return (
            <ExcelFile element={<button style={{backgroundColor:colors.blue['600'],color:"#ffffff", marginRight:"10px"}} class="MuiButtonBase-root MuiButton-root makeStyles-deleteButton-456 MuiButton-text">Export Services</button>}>
